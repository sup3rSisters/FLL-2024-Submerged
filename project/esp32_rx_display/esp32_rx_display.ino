// esp32-rx-display
//
// Sketch for receiving sound data using "ggwave"
//
// Tested MCU boards:
...
void setup() {
...
#ifdef DISPLAY_OUTPUT
    {
        ...
        display.println(F("FLL"));

        display.setTextSize(1);
        display.println(F(""));
        display.println(F("Unstoppable Tech"));
...
#ifdef DISPLAY_OUTPUT		
        display.clearDisplay();
        int len = strlen((char *) result.data());
        display.setTextSize(len > 8 ? 2 : 3);
